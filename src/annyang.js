...
!(function(a, b) {
  ...
  var e,
    ...
    t = function(a) {
      return (a = a
        ...
        .replace(r, "(.*?)")
        .replace(p, "\\s*$1?\\s*")), new RegExp("^" + a + "$", "i");
    },
    u = function(a) {
      for (
    ...
    y = function(a, b, c) {
      g.push({ command: a, callback: b, originalPhrase: c }), k &&
        w("Command successfully loaded: %c" + c, l);
    },
    z = function(a) {
      u(h.result, a);
      for (var b, c = 0; c < a.length; c++) {
        ...
        for (var d = 0, e = g.length; d < e; d++) {
          ...
          if (i) {
            var j = i.slice(1);
            return k &&
              (w("command matched: %c" + f.originalPhrase, l), j.length &&
                w("with parameters", j)), f.callback.apply(this, j), void u(
              h.resultMatch,
              b,
              f.originalPhrase,
              a
  ...
  return (c = {
    init: function(l) {
      ...
      e &&
        e.abort &&
        e.abort(), (e = new d()), (e.maxAlternatives = 5), (e.continuous =
        "http:" === a.location.protocol), (e.lang =
        "en-US"), (e.onstart = function() {
        (n = !0), u(h.start);
    ...
    start: function(a) {
      x(), (a = a || {}), (m = a.paused !== b && !!a.paused), (f =
        a.autoRestart === b || !!a.autoRestart), a.continuous !== b &&
        (e.continuous = !!a.continuous), (i = new Date().getTime());
      try {
        e.start();
      } catch (a) {
        k && w(a.message);
    ...
    removeCommands: function(a) {
      a === b
        ? (g = [])
        : ((a = Array.isArray(a) ? a : [a]), (g = g.filter(function(b) {
            for (
              var c = 0;
              c < a.length;
              c++
